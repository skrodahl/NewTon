            ...
            if (tournament.name && (tournament.status === 'setup' || tournament.status === 'active')) {
                titleElement.innerHTML = `
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        ...
                        <div id="match-controls-clock" style="display: inline-block; font-weight: normal; font-family: 'SF Mono', 'Consolas', 'Monaco', 'Menlo', monospace; border: 1px solid #ccc; padding: 8px 16px; border-radius: 6px;">${currentTime}</div>
                    </div>
                `;
            } else {
                titleElement.innerHTML = `
