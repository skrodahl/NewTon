...
The safe slice of Phase 4. Still deferred to a later release: save-path write ordering (4.2), analytics-preview isolation (4.3 — reassessed as a low-priority analytics-only-mode edge), and NewtonDB write atomicity (4.6).
