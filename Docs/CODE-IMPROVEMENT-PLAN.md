...
> **Status (2026-09-06): IN PROGRESS.** Done so far: **6.6**, **6.7**, **6.9**, **6.10**, **6.12**–**6.21** (2026-08-09, browser-verified where visual), **6.3** and **6.1 part A** (2026-09-06). Remaining: **6.1 part B** (declined for now, see the row), **6.2**, **6.4**, **6.5**, **6.8**, **6.11**. Each item is independent.
