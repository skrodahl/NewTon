...
2. Double-click on `tournament.html` to open NewTon DC Tournament Manager, and you're up and running
3. Visit our [User Guide](https://darts.skrodahl.net/userguide.html) to learn how to run and manage tournaments
